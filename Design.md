...
| Date | Activity |
--- | ---
| Day 01 | <ul> <li>Reading the requirements document </li> <li>Going through `Quandle` API and identify which endpoints to use ( This gave a rough idea how the User Interface might look). </li> <
| Day 02 | <ul> <li> Design component architecture & my data format </li><li> Identify component hierarchy</li><li>Data flow between components </li><li> Design Data structure of my application</li><li> setup my my react
application</li> </ul> |
